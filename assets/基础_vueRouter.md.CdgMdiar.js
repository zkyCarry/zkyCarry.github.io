import{_ as s,c as n,o as a,a1 as p}from"./chunks/framework.BLNEObz3.js";const v=JSON.parse('{"title":"vue Router","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"基础/vueRouter.md","filePath":"基础/vueRouter.md"}'),e={name:"基础/vueRouter.md"},t=p(`<h1 id="vue-router" tabindex="-1">vue Router <a class="header-anchor" href="#vue-router" aria-label="Permalink to &quot;vue Router&quot;">​</a></h1><p>vue Router</p><h2 id="全部" tabindex="-1">全部 <a class="header-anchor" href="#全部" aria-label="Permalink to &quot;全部&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>vue router</span></span>
