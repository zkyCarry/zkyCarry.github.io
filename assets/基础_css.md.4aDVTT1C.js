...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">4. rem root节点下字体大小 font-size:16px;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">子类： flex 缩写： flex-grow 比例  flex-shrink flex-basis。默认： 1，1 0；  flex-grow：2站两倍 其他一倍， flex-shrink 是否缩放 0 不缩放。  self-algin。</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">justify-content 株洲对其， align-items 横轴堆积。 flex-direction： 设置主轴很轴。   flex-wrap：no-warp； wrap-revese。 </span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">子类使用哪个网格： 编号网格线， 命名网格线， 命名网格区域 grid-template-areas。</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">25. reset.css 有库。 normalize.css</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">32. 动画相关 transition ：属性，持续时间，线性(可以自定义，贝塞尔，steps阶梯函数)，等待时间。 过渡 tranfrom：矩阵，倾斜，旋转，缩放，位移。 tranlate。  @keyframe </span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">animation：xxx， 持续时间， 线性，等待时间。 </span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">38. bfc 双飞翼 圣杯？</span></span></code></pre></div>`,4),t=[p];function e(E,h,k,r,d,c){return i(),a("div",null,t)}const y=s(l,[["render",e]]);export{g as __pageData,y as default};
