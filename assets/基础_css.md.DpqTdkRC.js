import{_ as s,c as a,o as i,a1 as n}from"./chunks/framework.Bk1mwsJI.js";const g=JSON.parse('{"title":"CSS","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"基础/css.md","filePath":"基础/css.md"}'),l={name:"基础/css.md"},p=n(`<h1 id="css" tabindex="-1">CSS <a class="header-anchor" href="#css" aria-label="Permalink to &quot;CSS&quot;">​</a></h1><p>CSS基本介绍</p><h2 id="will-change" tabindex="-1">will-change <a class="header-anchor" href="#will-change" aria-label="Permalink to &quot;will-change&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>will-change: transform; //默认值是auto，是告诉浏览这个节点可能会发生什么变化，浏览器会提前分配和优化资源，节点加</span></span>
<span class="line"><span>入 will-change 后，元素会被提升单独的复合层(影响子元素)。 如果所有节点都加入will-change，每个都创建一个复合层，反而更会影响性能，根据情况，只需要把动画相关的节点加入 will-change: transform;。</span></span></code></pre></div><h2 id="全部" tabindex="-1">全部 <a class="header-anchor" href="#全部" aria-label="Permalink to &quot;全部&quot;">​</a></h2><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">1. css 深入解析</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">4. env(safe-area-inset-left): 设备左侧安全区域的大小。</span></span></code></pre></div>`,6),e=[p];function t(E,h,k,r,c,d){return i(),a("div",null,e)}const y=s(l,[["render",t]]);export{g as __pageData,y as default};
