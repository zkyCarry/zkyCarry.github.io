import{_ as a,c as n,o as s,a1 as p}from"./chunks/framework.D01xxF7t.js";const g=JSON.parse('{"title":"uni-app 学习记录","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"记录/uni-app.md","filePath":"记录/uni-app.md"}'),l={name:"记录/uni-app.md"},e=p(`<h1 id="uni-app-学习记录" tabindex="-1">uni-app 学习记录 <a class="header-anchor" href="#uni-app-学习记录" aria-label="Permalink to &quot;uni-app 学习记录&quot;">​</a></h1><h2 id="文档" tabindex="-1">文档 <a class="header-anchor" href="#文档" aria-label="Permalink to &quot;文档&quot;">​</a></h2><p>官方文档：<a href="https://uniapp.dcloud.net.cn/" target="_blank" rel="noreferrer">https://uniapp.dcloud.net.cn/</a></p><h2 id="记录" tabindex="-1">记录 <a class="header-anchor" href="#记录" aria-label="Permalink to &quot;记录&quot;">​</a></h2><ul><li><ol><li>安装 HBuilder 官方的开发工具，打包也需要，肯定要装。 <a href="https://hx.dcloud.net.cn/Tutorial/install/macosx" target="_blank" rel="noreferrer">https://hx.dcloud.net.cn/Tutorial/install/macosx</a> (HBuilder 创建项目时可以选vue3)</li></ol></li><li><ol start="2"><li>安装微信开发者工具，浏览小程序时候需要。 (HBuilder-&gt;运行-》运行配置-》上面有个哥平台小程序IDE的下载地址。)</li></ol></li><li><ol start="3"><li>HBuilder -》 运行 -》 运行到小程序模拟器(运行配置配置好微信开发者工具的路径) -》 微信开发者工具(设置-》安全设置-》安全-》服务端端口(打开))</li></ol></li><li><ol start="4"><li>uniapp 内置了一些组件，不能直接使用html的标签。比如div，在uniapp中是<view></view>。 <a href="https://uniapp.dcloud.net.cn/component/view.html" target="_blank" rel="noreferrer">https://uniapp.dcloud.net.cn/component/view.html</a></li></ol></li><li><ol start="5"><li>开发代码模版，跟vue3基本一样</li></ol></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
