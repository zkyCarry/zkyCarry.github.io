import{_ as s,c as n,o as a,a1 as p}from"./chunks/framework.BLNEObz3.js";const g=JSON.parse('{"title":"webpack","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"基础/webpack.md","filePath":"基础/webpack.md"}'),l={name:"基础/webpack.md"},e=p(`<h1 id="webpack" tabindex="-1">webpack <a class="header-anchor" href="#webpack" aria-label="Permalink to &quot;webpack&quot;">​</a></h1><h2 id="全部" tabindex="-1">全部 <a class="header-anchor" href="#全部" aria-label="Permalink to &quot;全部&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>1.webpack核心概念</span></span>
...
<span class="line"><span>开发者将程序分解为功能离散的 chunk，并称之为 模块。可以把一些动态载入的模版，打包成专门的chunk。减少一进页面加载的内容。</span></span></code></pre></div>`,3),i=[e];function c(t,o,r,d,u,h){return a(),n("div",null,i)}const k=s(l,[["render",c]]);export{g as __pageData,k as default};
