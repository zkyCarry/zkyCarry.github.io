...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">38. 主要应用在自适应的网页：双飞翼：三栏布局，两边固定宽度，中间内容自适应宽度。 圣杯：包含页头和页脚。中间是双飞翼。</span></span></code></pre></div>`,4),t=[p];function e(E,h,k,r,d,c){return i(),a("div",null,t)}const y=s(l,[["render",e]]);export{g as __pageData,y as default};
