import{_ as s,c as n,o as a,a1 as p}from"./chunks/framework.PM4xAEU8.js";const v=JSON.parse('{"title":"vue3使用问题记录","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"基础/vue3使用问题记录.md","filePath":"基础/vue3使用问题记录.md"}'),e={name:"基础/vue3使用问题记录.md"},l=p(`<h1 id="vue3使用问题记录" tabindex="-1">vue3使用问题记录 <a class="header-anchor" href="#vue3使用问题记录" aria-label="Permalink to &quot;vue3使用问题记录&quot;">​</a></h1><h2 id="代码片段" tabindex="-1">代码片段 <a class="header-anchor" href="#代码片段" aria-label="Permalink to &quot;代码片段&quot;">​</a></h2><ul><li>全局变量使用</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>声明：app.config.globalProperties.$confirm = {alert: ()=&gt;{}}</span></span>
