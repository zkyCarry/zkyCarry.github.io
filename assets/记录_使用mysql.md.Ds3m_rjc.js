import{_ as s,c as a,o as n,a1 as p,aa as l,ab as e}from"./chunks/framework.PM4xAEU8.js";const _=JSON.parse('{"title":"使用mysql","description":"","frontmatter":{},"headers":[],"relativePath":"记录/使用mysql.md","filePath":"记录/使用mysql.md"}'),t={name:"记录/使用mysql.md"},i=p(`<h1 id="使用mysql" tabindex="-1">使用mysql <a class="header-anchor" href="#使用mysql" aria-label="Permalink to &quot;使用mysql&quot;">​</a></h1><h3 id="基本操作" tabindex="-1">基本操作 <a class="header-anchor" href="#基本操作" aria-label="Permalink to &quot;基本操作&quot;">​</a></h3><ol><li>安装参照 <a href="https://www.cnblogs.com/Andya/p/17384722.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/Andya/p/17384722.html</a></li><li>Navicat 数据库图标工具破解参照： <a href="https://www.cnblogs.com/Andya/p/17384722.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/Andya/p/17384722.html</a></li><li>环境变量配置：</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>export PATH=$PATH:/usr/local/mysql/bin</span></span>
