import{_ as s,c as n,o as a,a1 as p}from"./chunks/framework.zPfxmoh3.js";const _=JSON.parse('{"title":"pinia","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"基础/pinia.md","filePath":"基础/pinia.md"}'),e={name:"基础/pinia.md"},t=p(`<h1 id="pinia" tabindex="-1">pinia <a class="header-anchor" href="#pinia" aria-label="Permalink to &quot;pinia&quot;">​</a></h1><p>pinia</p><h2 id="全部" tabindex="-1">全部 <a class="header-anchor" href="#全部" aria-label="Permalink to &quot;全部&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>主要： state 、getters、actions。 没有vuex 的 mutation。</span></span>
